...
describe("bugsSlice", () => {
  ...
  describe("assigning bugs to a user", () => {
    it("should assign the bug to the user if it's saved to the server", async () => {
    ...
    it("should not assign the bug to the user if it's not saved to the server", async () => {
